...
namespace PS_Activity
{
    public class GsysSQL
    {
        ...
        public static string fncCheckImage(string lvPlanId, string lvCaneCount)
        {
            #region //Connect Database 
            MySqlConnection con = new MySqlConnection(System.Configuration.ConfigurationManager.ConnectionStrings["PSConnection"].ToString());
            MySqlCommand cmd = new MySqlCommand();
            ...
            cmd.Connection = con;
            con.Open();
            cmd.CommandText = "SELECT * FROM cane_activityimage WHERE PlanId = '" + lvPlanId + "' And CaneCount = '" + lvCaneCount + "'";
            dr = cmd.ExecuteReader();
            if (dr.HasRows)
            {
                while (dr.Read())
        ...
        public static string fncCheckSoil(string lvPlanId, string lvCaneCount)
        {
            #region //Connect Database 
            MySqlConnection con = new MySqlConnection(System.Configuration.ConfigurationManager.ConnectionStrings["PSConnection"].ToString());
            MySqlCommand cmd = new MySqlCommand();
            ...
            cmd.Connection = con;
            con.Open();
            cmd.CommandText = "SELECT * FROM cane_activitysoil WHERE PlanId = '" + lvPlanId + "' And CaneCount = '" + lvCaneCount + "'";
            dr = cmd.ExecuteReader();
            if (dr.HasRows)
            {
                while (dr.Read())
        ...
        public static string fncCheckFertilizer(string lvPlanId, string lvCaneCount)
        {
            #region //Connect Database 
            MySqlConnection con = new MySqlConnection(System.Configuration.ConfigurationManager.ConnectionStrings["PSConnection"].ToString());
            MySqlCommand cmd = new MySqlCommand();
            ...
            cmd.Connection = con;
            con.Open();
            cmd.CommandText = "SELECT * FROM cane_activityfertilizer WHERE PlanId = '" + lvPlanId + "' And CaneCount = '" + lvCaneCount + "'";
            dr = cmd.ExecuteReader();
            if (dr.HasRows)
            {
                while (dr.Read())
        ...
        public static string fncCheckWater(string lvPlanId, string lvCaneCount)
        {
            #region //Connect Database 
            MySqlConnection con = new MySqlConnection(System.Configuration.ConfigurationManager.ConnectionStrings["PSConnection"].ToString());
            MySqlCommand cmd = new MySqlCommand();
            ...
            cmd.Connection = con;
            con.Open();
            cmd.CommandText = "SELECT * FROM cane_activitywater WHERE PlanId = '" + lvPlanId + "' And CaneCount = '" + lvCaneCount + "'";
            dr = cmd.ExecuteReader();
            if (dr.HasRows)
            {
                while (dr.Read())
        ...
        public static string fncCheckChemical(string lvPlanId, string lvCaneCount)
        {
            #region //Connect Database 
            MySqlConnection con = new MySqlConnection(System.Configuration.ConfigurationManager.ConnectionStrings["PSConnection"].ToString());
            MySqlCommand cmd = new MySqlCommand();
            ...
            cmd.Connection = con;
            con.Open();
            cmd.CommandText = "SELECT * FROM cane_activitychemical WHERE PlanId = '" + lvPlanId + "' And CaneCount = '" + lvCaneCount + "'";
            dr = cmd.ExecuteReader();
            if (dr.HasRows)
            {
                while (dr.Read())
